<?php
/**
 * Plugin Name: BrickYard Social Widget
 * Description: Display links to profiles on the most popular social networks.
 * Author: WPlook Team and Tomas Toman	
 * Version: 1.3
*/

add_action('widgets_init', create_function('', 'return register_widget("brickyardsocial");'));
class brickyardsocial extends WP_Widget {
	function brickyardsocial() {
		$widget_ops = array('classname' => 'brickyardsocial', 'description' => __('A Social widget by BrickYard', 'brickyard') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('brickyardtsoc', __('BrickYard Social Widget', 'brickyard'), $widget_ops, $control_ops);
	}
...
if ( $instance ) {
	...
	if ( $instance ) {
        ...
        if ( $instance ) {
			...
			$googleplus = __( '', 'brickyard' );
		} 
        if ( $instance ) {
			$youtube = esc_attr( $instance[ 'youtube' ] );
		}
		else {
			$youtube = __( '', 'brickyard' );
		}
		...
		if ( $instance ) {
			...
			$linkedin = __( '', 'brickyard' );
		} 
        if ( $instance ) {
			$delicious = esc_attr( $instance[ 'delicious' ] );
		}
		else {
			$delicious = __( '', 'brickyard' );
		} 
        if ( $instance ) {
			$pinterest = esc_attr( $instance[ 'pinterest' ] );
		}
		else {
			$pinterest = __( '', 'brickyard' );
		}
     	 if ( $instance ) {
...
<p>
	<label for="<?php echo $this->get_field_id('twitter'); ?>"> <img style="float: left; margin: 0 5px 0px 0; width: 12px; height: 12px;" src="<?php echo get_template_directory_uri()  ?>/functions/be/images/icons/twitter.png" />
		<?php _e('Twitter:', 'brickyard'); ?>
	</label>
	<input class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>" name="<?php echo $this->get_field_name('twitter'); ?>" type="text" value="<?php echo $twitter; ?>" />
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Twitter profile.', 'brickyard'); ?>
</p>
</p>
<!-- Facebook-->
<p>
	<label for="<?php echo $this->get_field_id('facebook'); ?>"> <img style="float: left; margin: 0 5px 0px 0; width: 12px; height: 12px;" src="<?php echo get_template_directory_uri()  ?>/functions/be/images/icons/facebook.png" />
		<?php _e('Facebook:', 'brickyard'); ?>
	</label>
	<input class="widefat" id="<?php echo $this->get_field_id('facebook'); ?>" name="<?php echo $this->get_field_name('facebook'); ?>" type="text" value="<?php echo $facebook; ?>" />
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Facebook profile, page or group.', 'brickyard'); ?>
</p>
</p>
<!-- RSS-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Google Plus profile', 'brickyard'); ?>
</p>
</p>
<!-- You Tube-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your YouTube profile.', 'brickyard'); ?>
</p>
</p>
<!-- Linkedin-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Linkedin profile.', 'brickyard'); ?>
</p>
</p>
<!-- Delicious-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Delicious profile.', 'brickyard'); ?>
</p>
</p>
<!--Pinterest-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Pinterest profile.', 'brickyard'); ?>
</p>
</p>
<!-- Flickr-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Flickr profile.', 'brickyard'); ?>
</p>
</p>
<!--Instagram-->
<p>
	<label for="<?php echo $this->get_field_id('instagram'); ?>"> <img style="float: left; margin: 0 5px 0px 0; width: 12px; height: 12px;" src="<?php echo get_template_directory_uri()  ?>/functions/be/images/icons/instagram.png" />
		<?php _e('Instagram:', 'brickyard'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Instagram profile.', 'brickyard'); ?>
</p>
</p>
<?php 
...
<?php if ( $title )
	...
	if ($flickr != "") {
		...
		// Instagram
		if ($instagram != "") {
			echo "<div class='social-item'>"."<a href='$instagram'><img src=\"". get_template_directory_uri() ."/images/icons/instagram.png\" alt=\"Instagram \" /></a><p><a href='$instagram'>Instagram</a></p>" ."</div>";
		}
    // RSS
		if ($rss != "") {

<?php
/**
 * Plugin Name: BrickYard Posts-Column Widget
 * Description: Displays the latest posts from the selected category as a column with highlighted first post.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("brickyard_homepage_column");'));
class brickyard_homepage_column extends WP_Widget {
	function brickyard_homepage_column() {
		$widget_ops = array('classname' => 'homepage-column-posts', 'description' => __('Displays the latest posts from the selected category as a column with highlighted first post.', 'brickyard') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('brickyardcolumn', __('BrickYard Posts-Column', 'brickyard'), $widget_ops, $control_ops);
	}

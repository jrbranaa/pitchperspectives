<?php
/**
 * Plugin Name: BrickYard Posts-Grid Widget
 * Description: Displays the latest posts from the selected category as a grid.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("brickyard_homepage_grid");'));
class brickyard_homepage_grid extends WP_Widget {
	function brickyard_homepage_grid() {
		$widget_ops = array('classname' => 'homepage-grid-posts', 'description' => __('Displays the latest posts from the selected category as a grid.', 'brickyard') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('brickyardgrid', __('BrickYard Posts-Grid', 'brickyard'), $widget_ops, $control_ops);
	}
...
<?php if ( has_post_thumbnail() ) : ?>
          ...
          <h2 class="post-entry-headline"><a title="<?php the_title(); ?>" href="<?php echo get_permalink(); ?>"><?php brickyard_short_title(); ?></a></h2>
          <p class="post-meta">
...
<?php endif; ?>
          ...
          <p><a href="<?php echo get_permalink(); ?>" class="read-more-link"><?php _e( 'Read more &gt;' , 'brickyard' ); ?></a></p>
        </article>
<?php endwhile; endif; ?>
<?php wp_reset_query(); ?>
      </div>

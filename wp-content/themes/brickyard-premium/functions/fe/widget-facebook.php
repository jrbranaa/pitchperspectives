<?php
/**
 * Plugin Name: BrickYard Facebook Like Box Widget
 * Description: Displays the Facebook Like Box.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("brickyard_facebook");'));
class brickyard_facebook extends WP_Widget {
	function brickyard_facebook() {
		$widget_ops = array('classname' => 'facebook-like-box', 'description' => __('Displays Facebook Like Box.', 'brickyard') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('brickyardhead', __('BrickYard Facebook Like Box Widget', 'brickyard'), $widget_ops, $control_ops);
	}
...
<p>
	<label for="<?php echo $this->get_field_id('likeurl'); ?>">
		<?php _e('Facebook Page URL:', 'brickyard'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the full URL of your Facebook Page that will be liked (example: http://www.facebook.com/FacebookDevelopers).', 'brickyard'); ?>
</p>
</p>
<!-- Height -->
<p>
	<label for="<?php echo $this->get_field_id('boxheight'); ?>">
		<?php _e('Like Box Height: (optional)', 'brickyard'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the height of Like Box. The value is in pixels, but in the field please write ONLY NUMBERS (without symbol "px")!', 'brickyard'); ?>
</p>
</p>
<!-- Show Faces -->
<p>
	<label for="<?php echo $this->get_field_id('showfaces'); ?>">
		<?php _e('Show Faces:', 'brickyard'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Specify whether to display profile photos of people who like the page.', 'brickyard'); ?>
</p>
</p>
<!-- Show Stream -->
<p>
	<label for="<?php echo $this->get_field_id('showstream'); ?>">
		<?php _e('Show Stream:', 'brickyard'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Specify whether to display a stream of the latest posts by the Page.', 'brickyard'); ?>
</p>
</p>
<?php 

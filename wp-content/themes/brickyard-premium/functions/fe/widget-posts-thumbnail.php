<?php
/**
 * Plugin Name: BrickYard Posts-Thumbnail Widget
 * Description: Displays the latest posts from the selected category as the thumbnails.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("brickyard_homepage_thumbnail");'));
class brickyard_homepage_thumbnail extends WP_Widget {
	function brickyard_homepage_thumbnail() {
		$widget_ops = array('classname' => 'homepage-thumbnail-posts', 'description' => __('Displays the latest posts from the selected category as the thumbnails.', 'brickyard') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('brickyardthumbnail', __('BrickYard Posts-Thumbnail', 'brickyard'), $widget_ops, $control_ops);
	}

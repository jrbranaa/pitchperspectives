...
class brickyard_Wp_Plugins_v301 {
	...
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'brickyard-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'brickyard_side_info_column' ) ) {
			$this->hook( 'brickyard_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class brickyard_Wp_Plugins

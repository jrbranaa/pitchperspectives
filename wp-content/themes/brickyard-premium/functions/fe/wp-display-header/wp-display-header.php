...
if ( ! class_exists( 'brickyard_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'brickyard_Wp_Display_Header',
	'activation'
) );


class brickyard_Wp_Display_Header extends brickyard_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return brickyard_Wp_Display_Header
	 */
...
} // End of class brickyard_Wp_Display_Header.
 ...
 * @return void
 */
function brickyard_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new brickyard_Wp_Display_Header;
}
add_action( 'init', 'brickyard_wpdh_instantiate', 1 );
